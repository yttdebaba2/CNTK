...
%rename(_deserialize) CNTK::UDFDeserializer::Deserialize;
...
%warnfilter(401) CNTK::UDFDeserializer;
...
%feature("director") CNTK::UDFDeserializer;
...
%rename(load_from_buffer) CNTK::Function::Load(const char*, size_t, const DeviceDescriptor&, const UDFDeserializerPtr&);
%feature("compactdefaultargs") CNTK::Function::Load(const char*, size_t, const DeviceDescriptor&, const UDFDeserializerPtr&);

// This overload is not used in python at the moment.
%ignore CNTK::Function::Load(std::istream&, const DeviceDescriptor&, const UDFDeserializerPtr&);
...
%shared_ptr(CNTK::UDFDeserializer)
