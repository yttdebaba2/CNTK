...
namespace CNTK
{
    ...
    /*static*/ FunctionPtr Function::Load(const std::wstring& filepath, const DeviceDescriptor& computeDevice, const UDFDeserializerPtr& deserializer)
    {
    ...
    /*static*/ FunctionPtr Function::Load(const char *buffer, size_t length, const DeviceDescriptor& computeDevice, const UDFDeserializerPtr& deserializer)
    {
    ...
    /*static*/ FunctionPtr Function::Load(std::istream& inputStream, const DeviceDescriptor& computeDevice, const UDFDeserializerPtr& deserializer)
    {
        Dictionary model;
        inputStream >> model;
        return Function::Deserialize(model, computeDevice, deserializer);
    ...
    /*static*/ FunctionPtr Function::Deserialize(const Dictionary& modelDictionary, const CNTK::DeviceDescriptor& device, const UDFDeserializerPtr& deserializer)
    {
